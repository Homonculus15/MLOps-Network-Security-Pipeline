import sys
from NetworkSecurity.components.ingestion import DataIngestion,DataIngestionConfig
...
from NetworkSecurity.components.trainer import ModelTrainer,ModelTrainerConfig
