...
DATA_INGESTION_DATABASE_NAME: str="Homonculus15"
DATA_INGESTION_DIR_NAME: str="ingestion"
...
DAT_VALIDATION_DRIFT_REPORT_FILE_NAME: str="report.yaml"
...
TRAINING_BUCKET_NAME="homonculus-nsbucket"